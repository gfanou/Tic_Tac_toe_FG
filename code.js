$(document).ready(function() {
    ...
    function checkWin(playerNum) {
        ...
        for (i = 0; i < 3; i++) {
            ...
            if ((grid[i][0] === grid[i][1] && grid[i][1] === grid[i][2]) &&
                grid[i][0] !== undefined && grid[i][1] !== undefined && grid[i][2] !== undefined) {
        ...
        for (i = 0; i < 3; i++) {
            ...
            if ((grid[0][i] === grid[1][i] && grid[1][i] === grid[2][i]) &&
                grid[0][i] !== undefined && grid[1][i] !== undefined && grid[2][i] !== undefined)
            {
        ...
        //check diagonal
        if (((grid[0][0] === grid[1][1] && grid[1][1] === grid[2][2]) || (grid[0][2] === grid[1][1]
            && grid[1][1] === grid[2][0])) && grid[1][1] !== undefined) {
    ...
    function endgame(num) {
        ...
        if (num === 1) {
            $(".modal_text").html("Player 1:(X) Wins!");
            $("#myModal").css("display", "block");
        }
        if (num === 2) {
            $(".modal_text").html("Player 2:(O) Wins!");
            $("#myModal").css("display", "block");
        }
    }
